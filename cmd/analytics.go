...
var analyticsSummaryCmd = &cobra.Command{
	...
	Example: `  sem-agent analytics summary --project my-app --days 7
  sem-agent analytics summary --project my-app --days 30 --branch main`,
...
var analyticsDurationCmd = &cobra.Command{
	...
	Example: `  sem-agent analytics duration --project my-app --days 30`,
	RunE: func(cmd *cobra.Command, args []string) error {
		pipelines, err := fetchAnalyticsPipelines()
		if err != nil {
			return err
...
var analyticsFailuresCmd = &cobra.Command{
	...
	Example: `  sem-agent analytics failures --project my-app --days 14`,
	RunE: func(cmd *cobra.Command, args []string) error {
		pipelines, err := fetchAnalyticsPipelines()
		if err != nil {
			return err
...
var analyticsQueueCmd = &cobra.Command{
	...
	Example: `  sem-agent analytics queue --project my-app --days 7`,
	RunE: func(cmd *cobra.Command, args []string) error {
		pipelines, err := fetchAnalyticsPipelines()
		if err != nil {
			return err
...
var analyticsDeploysCmd = &cobra.Command{
	...
	Example: `  sem-agent analytics deploys --project my-app --days 30`,
	RunE: func(cmd *cobra.Command, args []string) error {
		pipelines, err := fetchAnalyticsPipelines()
		if err != nil {
			return err
...
var analyticsTrendCmd = &cobra.Command{
	...
	Example: `  sem-agent analytics trend --project my-app --weeks 4
  sem-agent analytics trend --project my-app --weeks 8 --branch main`,
	RunE: func(cmd *cobra.Command, args []string) error {
...
func fetchAnalyticsPipelines() ([]analyticsPipeline, error) {
	if !config.IsConfigured() {
		return nil, fmt.Errorf("not configured — run 'sem-agent connect' first")
	}
